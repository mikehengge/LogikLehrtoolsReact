...
public class Main_Menu_Controller {
	 ...
	 */
	private static LinkedList<Input_Language> _languages;
	/**
	 ...
	 */
	public static Input_Language get_language(String selected_language)
	{
	 ...
	 */
	public static Formula_NF get_Formula(String given_formula,String method, Input_Language selected_language)
	{
		{
